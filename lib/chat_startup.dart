...
class ChatStartUp extends StatefulWidget {
  const ChatStartUp({super.key});

  @override
  State<ChatStartUp> createState() => _ChatStartUpState();
}

class _ChatStartUpState extends State<ChatStartUp> {
              ...
              child: SizedBox(
                ...
                child:Row(
                  children: [
                    ...
                    SizedBox(width: 10.w,),
                    const Text("WebEarl Technology Pvt Ltd",style: TextStyle(fontSize: 15,fontWeight: FontWeight.w600),)
                  ],
                ) ,
              ),
            ),
