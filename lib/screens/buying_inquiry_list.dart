...
class BuyingInquiryList extends StatefulWidget {
  const BuyingInquiryList({super.key});

  @override
  State<BuyingInquiryList> createState() => _BuyingInquiryListState();
}

class _BuyingInquiryListState extends State<BuyingInquiryList> {
  @override
          ...
          child: SingleChildScrollView(
            ...
            child: Column(
              children: [
                ...
                const Center(child: CustomTextWithBackground(text: 'Buying Inquiry List')),
