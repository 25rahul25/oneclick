...
class BuyingInquiry extends StatefulWidget {
  const BuyingInquiry({super.key});

  @override
  State<BuyingInquiry> createState() => _BuyingInquiryState();
}

class _BuyingInquiryState extends State<BuyingInquiry> {
  @override
          ...
          child: SingleChildScrollView(
            ...
            child: Column(
              ...
              children: [
                ...
                const Center(child: CustomTextWithBackground(text: 'Buying Inquiry Details')),
